...
<?php
$iidd = $_GET["id"];
$beauty = mysql_fetch_array(mysql_query("SELECT name, price, description, img FROM drinks WHERE id='".$iidd."'"));
echo "$beauty[0]";
?>
  ...
  <div id="front-slider" class="carousel slide"><!--Slider with interval speed of 40s-->
		<div class="container">
		  <div id="back" style="padding:4% 0px 4% 0px;text-align:center;">
			  <h3><a style="color:#ed1c24;" href="/papaye/index.php">HOME</a> > <a style="color:white;" href="/papaye/cat-drinks.php">DRINKS</a> > <span style="color:#ed1c24;text-transform: uppercase;"> 
			  <?php
$iidd = $_GET["id"];
$beauty = mysql_fetch_array(mysql_query("SELECT name, price, description, img FROM drinks WHERE id='".$iidd."'"));
echo "$beauty[0]";
...
<?php
$iidd = $_GET["id"];
$ppy = mysql_fetch_array(mysql_query("SELECT name FROM drinks WHERE id='".$iidd."'"));
?>
 <div class="container">
