...
<?php
 $ddaa = mysql_query("SELECT id, name, price, description, img FROM soups ORDER BY id DESC");
    echo mysql_error();
...
<a href=\"soups/$data[0]/$url\" class=\"page-scroll box-cta btn btn-book btn-warning\">READ MORE - BOOK</a>
</div></div></div> 
";
	}
 ?>
