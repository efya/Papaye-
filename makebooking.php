...
<div class="cat-des-bk">
  <div id="front-slider" class="carousel slide"><
		<div class="container">
...
$res = mysql_query("INSERT INTO appo SET name='".$name."', email='".$email."', mobile='".$mobile."', btext='".$btext."', ordered='".$saves."', what='2'");

if ($res){
echo "<h1>Your Booking is Successfull</h1>";
}else{
echo "<h1>There is a problem with your Booking. Please Try Again Or Call Us : +44 62 3023 2, +44 62 3023 1</h1>";
}
